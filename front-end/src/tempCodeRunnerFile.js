    ...
    <Routes>
      ...
      <div className="App" style={{backgroundImage: ""}}>
          <div className='container mainDiv' >
                ...
                <p className='welcome-p'>Welcome to Ironclade Land Registration and transfer of entitlement</p>

                <button className='landingPage-btn' onClick={connectToEthereum}>Connect to Ethereum Account</button>
            </div>
        </div>
      }/>
    </Routes>
